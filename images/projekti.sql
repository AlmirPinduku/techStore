...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 07, 2022 at 02:08 AM
...
(2, 'user', 'user', 'user@user.com', 'user', 'user1');
...
(41, 'Apple iPhone 14 Pro, 128GB, Deep Purple', '', '', 'Dell', 'Dizajni, qëndrueshmëria, funksionet dhe teknologjia e klasit të parë, e gjithë kjo dhe shumë më tepër fshihen në modelin Apple iPhone 14 Pro. Dynamic Island është një përvojë interaktive dhe tërheqëse e iPhone për të gjitha njoftimettt, ', NULL, NULL, NULL, NULL, '0000-00-00'),
(90, 'APPLEEE 13promaxx', '100000euro', 'bannerr.png', 'Lenovo', 'APPLEEEEEEEEEeeee', '+383458955511', '+383458955511', 'Prizren', 'AlmirPinduk', '2022-11-06');
...
(3, 'Almir', 'Pinduk', 'almir@star-workshop.com', '12425', 'Pinduk Almir would like to request an account.', '2022-11-07 00:04:56');
...
--
ALTER TABLE `produktet`
  MODIFY `produkt_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
