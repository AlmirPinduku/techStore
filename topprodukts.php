...
<header class="">
  ...
  <section class="w-full mx-auto bg-nordic-gray-light flex pt-16 md:pt-0 md:items-center bg-cover bg-right max-w-full bg-black" style="max-width:1600px; height: 19rem; background-image: url('./images/bannerr.png');">
