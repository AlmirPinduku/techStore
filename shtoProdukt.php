				...
				<form action="shtoProdukt.php" enctype="multipart/form-data" method="POST">
					<div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
						<div>
							...
							<input id="username" type="text" name="title" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-black rounded-md   focus:border-yellow-500 focus:outline-none">
						</div>

						<div>
							<label class="text-black" for="emailAddress">Çmimi në Euro</label>
							<input id="emailAddress" type="text" name="qmimi" value="€" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-black rounded-md   focus:border-yellow-500 focus:outline-none">
						</div>

						<div>
							<label class="text-black" for="password">Emri i Shpallesit Se Produktit</label>
							<input id="password" type="text" name="emriUser" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-black rounded-md   focus:border-yellow-500 focus:outline-none">
						</div>

						<div>
							<label class="text-black" for="passwordConfirmation">Qyteti</label>
							<input id="passwordConfirmation" type="text" name="qyteti" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-black rounded-md   focus:border-yellow-500 focus:outline-none">
						</div>

						<div>
							<label class="text-black" for="password">Viber Number</label>
							<input id="password" type="text" name="viberNumber" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-black rounded-md   focus:border-yellow-500 focus:outline-none">
						</div>

						<div>
							<label class="text-black" for="passwordConfirmation">WhatsApp Number</label>
							<input id="passwordConfirmation" type="text" name="wpNumber" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-black rounded-md   focus:border-yellow-500 focus:outline-none">
						</div>
						
						<div>
							<label class="text-black" for="passwordConfirmation">Brandi</label>
							<select name="keywords" class="block w-full px-4 py-2 mt-2 text-black bg-white border border-black rounded-md   focus:border-yellow-500 focus:outline-none">
						...
						<div>
							...
							<textarea id="textarea" type="textarea" name="content" rows="5"class="block w-full px-4 py-2 text-black bg-white border border-black rounded-md   focus:border-yellow-500 focus:outline-none"></textarea>
						</div>
					...
					<button type="submit" name="submit" class="inline-flex justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Shto Produktin</button>					</div>
				</form>
			</section>
