...
?>
<?php
$connect = mysqli_connect('localhost', 'root', '', 'projekti');
mysqli_select_db($connect, 'projekti');
...
if (isset($_POST['login'])) {
  ...
  if (empty($username) && empty($passwordi)) {
    ...
    $login = "SELECT * FROM register WHERE email='$username' AND passwordi='$passwordi'";
            ...
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                <div class="py-12 bg-red-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                    <div class="cursor-pointer flex items-center">
                        <div>
                            <svg class="w-10 text-red-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 225 225" style="enable-background:new 0 0 225 225;" xml:space="preserve">
                                <style type="text/css">
                        ...
                        <div class="text-2xl text-red-800 tracking-wide ml-2 font-semibold">blockify</div>
                    </div>
                </div>
                    ...
                    <div class="mt-12">
                        <form method="post" action="login.php">
                            <div>
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-red-500" type="text" name="email" required placeholder="Enter your Email">
                            </div>
                            <div class="mt-8">
                                ...
                                <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-red-500" type="password" name="passwordi" required placeholder="Enter your password">
                            </div>
                            <div class="mt-10">
                                <button type="submit" name="login" value="Login" class="bg-red-500 text-gray-100 p-4 w-full rounded-full tracking-wide
                        ...
                        <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                            Don't have an account ? <a href="#" class="cursor-pointer text-red-600 hover:text-red-800">Sign up</a>
                        </div>
                    </div>
                </div>
            </div>
