...
mysqli_select_db($conn, 'projekti');
...
if (isset($_POST['login'])) {
    ...
    $query = "SELECT * FROM register WHERE emri='$emri' AND email='$email' AND username='$username' LIMIT 1";
    ...
    if (count($errors) == 0) {
        ...
        $regist = "INSERT INTO register(emri,mbiemri,username,email,passwordi)
        VALUES ('$emri','$mbiemri','$username','$email','$passwordi')";

        $rows = "SELECT * FROM register WHERE emri='$emri' AND email='$email'";
        ...
        if (mysqli_num_rows($run) < 100) {
            ...
            echo "window.open('Register.php','_self')";
    ...
    <div class="lg:flex">
        ...
        <div class="lg:w-1/2 xl:max-w-screen-sm">
            <div class="py-12 bg-red-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
                <div class="cursor-pointer flex items-center">
                    <div>
                        <svg class="w-10 text-red-500" xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="mt-12">
                    <form method="POST" action="./register.php">
                        <div>
                            ...
                            <input
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-red-500"
                                type="text" name="emri" placeholder="Name" />
                        </div>

                        <div class="mt-8">
                            <div class="text-sm font-bold text-gray-700 tracking-wide">Surname</div>
                            <input
                                class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-red-500"
                                type="text" name="mbiemri" placeholder="Surname" />
                        </div>
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        You can login here <a href="#" class="cursor-pointer text-red-600 hover:text-red-800">Login</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="hidden lg:flex items-center justify-center bg-indigo-100 flex-1 h-screen">
            <div class="max-w-xs transform duration-200 hover:scale-110 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="564.98435" height="512.2962"
                    viewBox="0 0 564.98435 512.2962" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g>
                        <path
                    ...
                    <path d="M264.23446,133.5s14-4,17,2,10,85,10,85l-13.5,63.05905-15.5-4.05905,8-64-11-48,5-34Z"
                        fill="#e6e6e6" />
                    <g>
                        <circle cx="58.49998" cy="266.83965" r="58.49999" fill="#ff6366" />
                        <path
