...
<table class="h-full w-screen container justify-center ml-72">
		<h1 class="w-full flex justify-center items-center h-16 text-2xl bg-black text-white">Shiko te gjitha produktet</h1>
	<tr>
