...
<body>
	...
	<h1 class="w-full flex justify-center items-center h-16 text-2xl bg-black text-white">Shto nje produkt te ri ketu
	</h1>
	<form method="post" action="insert_produkt.php" enctype="multipart/form-data" class="flex justify-center">
		...
		<table class="h-full w-screen container  mt-10">
			...
			<tr class="w-fit h-12">
				<td>
				<td class=" text-white "><input type="submit" name="submit" value="Shtoje tani"
						class="bg-black px-5 py-2.5 mr-2 rounded-lg hover:bg-green-800"></td>
			</tr>
