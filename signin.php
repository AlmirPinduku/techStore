		...
		<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
			<form method="post" class="bg-white">
				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<input class="pl-2 outline-none border-none" name="firstname" type="text" required id=""
				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<input class="pl-2 outline-none border-none" name="lastname" type="text" required id=""
				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<input class="pl-2 outline-none border-none" name="email" type="email" required id=""
				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl">
					...
					<input class="pl-2 outline-none border-none" name="password" type="password" required id=""
						placeholder="Password" />
				</div>
				<button type="submit" name="signup"
					class="block w-full bg-gradient-to-tr from-yellow-300 to-orange-700  mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Signup</button>
				<span class="text-sm ml-2  cursor-pointer">You may also<a href="login.php"
						class="text-sm ml-1 hover:text-orange-500 cursor-pointer">Login</a>
					here </span><br>
